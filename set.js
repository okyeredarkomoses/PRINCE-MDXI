...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRINCE-MDX~jj9W4F6mSmH9rP3dYdpU", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "233240224852", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "ACOSTIC", // Input Yours custom...(Maintain font for Flow)
